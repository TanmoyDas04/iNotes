...
<html lang="en">
  ...
  <body style="font-family: 'Dancing Script', cursive;">
    ...
    ?>
        ...
        <form action="inc/_edit.php?id=<?php echo $id;?>" method="post">
        <h1 class="display-4"><input type="text" class="form-control" id="Edit_title" aria-describedby="emailHelp" name="Edit_title" value="<?php echo $row['title'];?>" placeholder="Enter title of note"></h1>
        <p class="lead"><textarea class="form-control" name="Edit_description" id="Edit_description" cols="30" rows="12" placeholder="Enter description of note"><?php echo $row['description'];?></textarea></p>
        <br class="my-4">
        <input type="submit" class="btn btn-danger btn-lg" role="button" value="Edit Note" name="Edit_Note">
        </form>
        </div>
    <?php
    }
